    ...
    <body class="un-b-dashboard">
            <div class="colorpicker">
                <div class="row done">
                    ...
                    <p class="text-normal second">ok</p>
                </div>
                <div class="row active" >
                    <p class="text-normal first">Active</p>   
                    <p class="text-normal second">ok</p>         
                </div>
                <div class="row waiting">
                    <p class="text-normal first">Waiting</p>
                    <p class="text-normal second">ok</p>
                </div>
                <div class="row unactive">
                    <p class="text-normal first">Not assigned</p>
                    <p class="text-normal second">Not</p>
                </div>
                <div class="row problem">
                    <p class="text-normal first">Problem</p>
                    <p class="text-normal second">lol</p>
                </div>
            </div>           
            <section class="welcome container" id="welcome">
                <p class="time" id="actualTime">0</p>
                <p class="text-normal" id="actualDate">Friday, April 01</p>
                <div class="row" id="iconlist">
                    <a class="item">
                        <span class="icon-big blue">
                    ...
                    <a class="item" id="dashboard-open">
                        <span class="icon-big blue">
                ...
                <section class="dashboard" id="dashboard">
                    <div class="sidebar ">
                        <nav>
                            ...
                            <p id="home">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                                    <path d="M1.75 13L4.25 10.5M4.25 10.5L13 1.75L21.75 10.5M4.25 10.5V23C4.25 23.3315 4.3817 23.6495 4.61612 23.8839C4.85054 24.1183 5.16848 24.25 5.5 24.25H9.25M21.75 10.5L24.25 13M21.75 10.5V23C21.75 23.3315 21.6183 23.6495 21.3839 23.8839C21.1495 24.1183 20.8315 24.25 20.5 24.25H16.75M9.25 24.25C9.58152 24.25 9.89946 24.1183 10.1339 23.8839C10.3683 23.6495 10.5 23.3315 10.5 23V18C10.5 17.6685 10.6317 17.3505 10.8661 17.1161C11.1005 16.8817 11.4185 16.75 11.75 16.75H14.25C14.5815 16.75 14.8995 16.8817 15.1339 17.1161C15.3683 17.3505 15.5 17.6685 15.5 18V23C15.5 23.3315 15.6317 23.6495 15.8661 23.8839C16.1005 24.1183 16.4185 24.25 16.75 24.25M9.25 24.25H16.75" stroke="#758591" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </p>
                            <p id="openoverview">
                            ...
                            <div class="cratenewdash-container">
                                <p id="createnewdashboard">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                        <path d="M21.25 17.5V25M17.5 21.25H25M7.5 12.5H10C10.663 12.5 11.2989 12.2366 11.7678 11.7678C12.2366 11.2989 12.5 10.663 12.5 10V7.5C12.5 6.83696 12.2366 6.20107 11.7678 5.73223C11.2989 5.26339 10.663 5 10 5H7.5C6.83696 5 6.20107 5.26339 5.73223 5.73223C5.26339 6.20107 5 6.83696 5 7.5V10C5 10.663 5.26339 11.2989 5.73223 11.7678C6.20107 12.2366 6.83696 12.5 7.5 12.5ZM20 12.5H22.5C23.163 12.5 23.7989 12.2366 24.2678 11.7678C24.7366 11.2989 25 10.663 25 10V7.5C25 6.83696 24.7366 6.20107 24.2678 5.73223C23.7989 5.26339 23.163 5 22.5 5H20C19.337 5 18.7011 5.26339 18.2322 5.73223C17.7634 6.20107 17.5 6.83696 17.5 7.5V10C17.5 10.663 17.7634 11.2989 18.2322 11.7678C18.7011 12.2366 19.337 12.5 20 12.5ZM7.5 25H10C10.663 25 11.2989 24.7366 11.7678 24.2678C12.2366 23.7989 12.5 23.163 12.5 22.5V20C12.5 19.337 12.2366 18.7011 11.7678 18.2322C11.2989 17.7634 10.663 17.5 10 17.5H7.5C6.83696 17.5 6.20107 17.7634 5.73223 18.2322C5.26339 18.7011 5 19.337 5 20V22.5C5 23.163 5.26339 23.7989 5.73223 24.2678C6.20107 24.7366 6.83696 25 7.5 25Z" stroke="#758591" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </p>
                                <form class="row alc">
                                    @csrf
                                    <input type="text" name="name" id="workspace-name" class="input-add" placeholder="name"/>
                                    <button id="workspace-create" type="submit" class="btn-2 button-add">add</button>
                                </form>
                            </div>
                        </nav>
                        <div class="overview hide" id="overview">
                            ...
                            <ul><!-- filter by alphabet automatical-->
                                <li class="active text-normal" onclick="showWorkspace('academy')">Academy</li>
                                @if(isset($workspaces))
                                    @foreach ($workspaces as $workspace)
                                            <li class="text-normal" onclick="showWorkspace('{{ $workspace->id }}')">{{ $workspace->name }}</li>
                                    @endforeach
                                @endif
                            </ul>
                        </div>
                    </div>
                    <div class="workspace active row" id="academy">
                        <div class="padding-default">
                            <div class="row alt spb">
                                <h1 class="heading">Academy</h1>
                                <div class="row">  
                                    <button class="btn-1 addcontainer"><img src="{{asset('/img/plus.svg')}}" alt=""></button>
                                    <img class="infoAboutProject" src{{asset('/img/dots-vertical.svg')}}" alt="">
                                </div>
                            </div>
